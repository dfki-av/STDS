...
def main(args):
    ...
    transformer_model = get_models(args).to(device, dtype=torch.float32)
    ...
    text_encoder = T5EncoderModel.from_pretrained(args.pretrained_model_path, subfolder="text_encoder", torch_dtype=torch.float32).to(device)
